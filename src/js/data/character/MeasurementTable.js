...
let bodyTypes = [
    ...
    { "Fit": { bodyFat: [0.8,0.1], statMods: { strg: 1.2, dex: 1.2, con: 1.2 }, expMods: { agility: 2, size: 1, skill: 1 }, loot: [6] } },
    { "Muscle": { bodyFat: [0.05,0.8], statMods: { strg: 2, dex: 0.8, con: 1.5 }, expMods: { muscle: 2, size: 1, skill: 1 }, loot: [0] } },
