let genders = [
    {"Male": { type: "Male", penis: true, balls: true, vagina: false, breasts: false, pronouns: 0 }},
    {"Female": { type: "Female", penis: false, balls: false, vagina: true, breasts: true, pronouns: 1 }},
    {"Futa": { type: "Futa", penis: true, balls: true, vagina: true, breasts: true, pronouns: 3 }},
    {"Futa No Balls": { type: "Futa", penis: true, balls: false, vagina: true, breasts: true, pronouns: 3 }},
    {"Futa No Breasts": { type: "Futa", penis: true, balls: true, vagina: true, breasts: false, pronouns: 3 }},
    {"Futa No Breasts & No Balls": { type: "Futa", penis: true, balls: false, vagina: true, breasts: false, pronouns: 3 }},
    {"Cuntboi": { type: "Cuntboi", penis: false, balls: false, vagina: true, breasts: false, pronouns: 2 }}
]
