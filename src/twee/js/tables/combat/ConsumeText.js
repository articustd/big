let muchSmallerText = {
    Eat: `Looking down you see the $enemy.name. Their form before you, small enough to fit in your paw.
...
let smallerText = {
    Eat: `Looking down you see the $enemy.name. Their form before you, coming up to around your hip.
...
let sameText = {
    Eat: `Looking down you see the $enemy.name. Their form coming in roughly the same size as you.
...
let largerText = {
    Eat: `Looking down you see the $enemy.name. Their form slightly looming in front of you.
...
let muchLargerText = {
    Eat: `Looking up you see the $enemy.name. Their stature dwarfing yours.
