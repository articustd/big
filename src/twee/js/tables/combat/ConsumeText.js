let muchSmallerText = {
    Eat: `Looking down you see the $enemy.name. Their _enemyText.sizeLC form before you, small enough to fit in the center of your paw.
    ...
    <br>When the prey reaches your stomach, they make a _enemyText.sizeLC bump under your skin. Sitting back you rub the bump and revel in the afterglow of your consumption. After coming down from the experience, you pick up everything from your altercation and move on patting your stomach.`,
    Anal: ``,
    Unbirth: ``,
    Sound: ``
}
...
let smallerText = {
    Eat: `Looking down you see the $enemy.name. Their _enemyText.sizeLC form before you, only coming up to your hip.
...
let sameText = {
    Eat: `Looking down you see the $enemy.name. Their _enemyText.sizeLC form before you, roughly the same size as you.
...
let largerText = {
    Eat: `Looking down you see the $enemy.name. Their _enemyText.sizeLC form slightly looming in front of you.
    <br>You let out a sigh, that was pretty rude of the $enemy.name to fight you. They had the height advantage and everything! As you complain to yourself a strong scent comes to your nose. Taking a moment to think on the smell, your mouth begins to water. Looking for the source of the delicious smell, your eyes fall on the _enemyText.sizeLC opponent and your stomach begins to gurgle. You're not sure how you would begin to eat them, but you know you have to.
    ...
    <br>Gingerly taking a step, you feel the bottom of your belly drag on the ground. It's not as bad as you expected it to be. Sliding over to the $enemy.name's things you pick them up and slowly make your way back.`,
    Anal: ``,
    Unbirth: ``,
    Sound: ``
}
...
let muchLargerText = {
    Eat: `Looking up you see the $enemy.name. Their _enemyText.sizeLC form dwarfs you.
    ...
    <br>Unhinging your jaw you start to slide the _enemyText.sizeLC cranium into your maw. It's crazy to you how this much can fit into you, almost unnatural. The head fully in your mouth, start to choke down their neck. The feeling of unease starts to creep in.
    ...
    <br>Your not sure how, but you think you'll have to convice someone larger to carry you around. Good luck with that!`,
    Anal: ``,
    Unbirth: ``,
    Sound: ``
}